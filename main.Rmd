...
model_definitions <- list(
  Model1 = data.frame(x4 = X$x4, x3 = X$x3^2),
  Model2 = data.frame(x4 = X$x4, x3 = X$x3^2, x5 = X$x5),
  Model3 = data.frame(x3 = X$x3, x4 = X$x4, x5 = X$x5^3),
  Model4 = data.frame(x4 = X$x4, x3 = X$x3^2, x5 = X$x5^3),
  Model5 = data.frame(x4 = X$x4, x1 = X$x1^2, x3 = X$x3^2)
)
